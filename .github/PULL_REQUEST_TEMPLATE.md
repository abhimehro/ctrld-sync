...
- Store them in a `.env` file at the project root (already listed in
  `.gitignore`):
...
- [ ] Branch follows naming convention (`fix/<short-description>`,
      `feat/<short-description>`, `docs/<short-description>`,
      `chore/<short-description>`, etc.)
...
- [ ] No secrets, credentials, tokens, profiles, or `.env` files are included in
      this PR
