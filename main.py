...
def _create_action_from_dict(data: dict[str, Any]) -> RuleAction:
    """Extracts rule action from a dictionary, with defaults."""
...
def _process_single_folder(
    ...
    main_action = _create_action_from_dict(grp)
    ...
    if "rule_groups" in folder_data:
        for rule_group in folder_data["rule_groups"]:
            action = _create_action_from_dict(rule_group)
